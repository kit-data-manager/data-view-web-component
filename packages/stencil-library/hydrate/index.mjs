...
const NAMESPACE = 'data-view-web-component';
const BUILD = /* data-view-web-component */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", propChangeCallback: false, slotRelocation: true, state: true, updatable: true};

const globalStyles = ":root{--mainBG:#cbcbcb;--darkerBG:#bdbdbd;--lighterBG:#cdcdcd;--mainText:#000;--secondaryText:#444444;--scrollbarThumbBG:#888;--scrollbarThumbHoverBG:#555;--tagText:#fff}";

/*
 Stencil Hydrate Platform v4.41.0 | MIT Licensed | https://stenciljs.com
 */
...
const LabelValue = ({ label, value, alignRight, valueTextClass, url, target, detailed }) => {
    return (hAsync("div", { class: "label-value-wrapper", part: "label-value-wrapper" }, hAsync("span", { class: `label ${alignRight ? 'alignRight' : ''}`, part: `${detailed ? 'detailed-label' : ''} label ${alignRight ? 'alignRight' : ''}` }, label), url ? (hAsync("a", { href: url, target: target, class: `${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}`, part: `${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}`, style: { textDecoration: 'underline' } }, hAsync("span", { class: `${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}`, part: `${detailed ? 'detailed-value' : ''} ${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}` }, value))) : (hAsync("span", { class: `${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}`, part: `${detailed ? 'detailed-value' : ''} ${alignRight ? 'alignRight' : ''} ${valueTextClass !== null && valueTextClass !== void 0 ? valueTextClass : 'value'}` }, value))));
};
...
const TextProp = (props) => {
    ...
    if (typeof prop === 'string') {
        if (prop.match(/<[^>]*>/)) {
            return hAsync("div", { class: textClass, part: textClass, innerHTML: prop });
        }
        return (hAsync("p", { class: textClass, part: textClass }, prop));
    }
    return hAsync(LabelValue, Object.assign({ valueTextClass: textClass, value: prop.value, label: prop.label }, props));
};

const TagComponent = ({ tag, onActionPress }) => {
    ...
    if (!('eventIdentifier' in tag)) {
        ...
        if (!clickable) {
            return (hAsync("a", { class: "tag", title: tooltip, part: "tag", style: { backgroundColor: tag.color, pointerEvents: pointable ? undefined : 'none', cursor: 'default' } }, tag.iconName ? hAsync("iconify-icon", { icon: tag.iconName, class: "tag-icon", part: "tag-icon" }) : null, hAsync("span", { class: "tag-text", part: "tag-text", style: { textDecoration: 'none' } }, tag.text)));
        }
        return (hAsync("a", { class: "tag", title: tooltip, part: "tag", style: { backgroundColor: tag.color, pointerEvents: clickable || pointable ? undefined : 'none' }, href: url, target: target }, tag.iconName ? hAsync("iconify-icon", { icon: tag.iconName, class: "tag-icon", part: "tag-icon" }) : null, hAsync("span", { class: "tag-text", part: "tag-text", style: { textDecoration: clickable ? 'underline' : 'none' } }, tag.text)));
    }
    else {
        return (hAsync("button", { title: tooltip, onClick: () => onActionPress(tag.eventIdentifier), class: "tag", part: "tag-btn", style: { backgroundColor: tag.color } }, tag.iconName ? hAsync("iconify-icon", { icon: tag.iconName, height: "1.5em", part: "tag-icon" }) : null, tag.text ? (hAsync("span", { class: "tag-text", part: "tag-text" }, tag.text)) : null));
    }
};
...
const ActionButton = ({ action, onActionPress, noLabel }) => {
    ...
    return (hAsync("button", { type: "button", onClick: handleClick, title: tooltip, class: "action-btn-icon", part: "action-btn-icon", "aria-label": noLabel ? action.label : undefined }, hAsync("iconify-icon", { icon: action.iconName, height: "1.5em", part: "action-btn-iconify" }), noLabel ? null : (hAsync("span", { class: "subtitle", part: "subtitle" }, action.label))));
};

const dataCardCss = () => `:host{--borderRadius:16px;--padding:16px;display:block}*{font-family:Roboto, sans-serif}::-webkit-scrollbar{width:10px}::-webkit-scrollbar-track{background:transparent;border-radius:var(--borderRadius);overflow:hidden}::-webkit-scrollbar-thumb{background:var(--scrollbarThumbBG);border-radius:var(--borderRadius)}::-webkit-scrollbar-thumb:hover{background:var(--scrollbarThumbHoverBG)}button,input[type='submit'],input[type='reset'],a{background:none;text-decoration:none;color:inherit;border:none;padding:0;font:inherit;cursor:pointer;outline:inherit}.card-container{width:-webkit-fill-available;position:relative;padding:var(--padding);border-radius:var(--borderRadius);background-color:var(--mainBG);display:flex;overflow:hidden;gap:10px;z-index:10}.main-card-body{display:flex;flex-direction:row;flex:1}.default-children-button{display:flex}.children-btn-label{text-decoration:underline}.modal{height:"100%";width:-webkit-fill-available;background-color:transparent;display:flex;justify-content:center;align-items:center;padding:2em}.default-action-btns-container{display:flex;gap:0.5em}.default-card-footer{display:flex;justify-content:space-between;align-items:flex-end;flex:1}.children-container{position:relative;z-index:1;margin-top:calc(var(--padding) * -1);padding:var(--padding);padding-top:32px;background-color:var(--darkerBG);height:-webkit-fill-available;border-bottom-left-radius:var(--borderRadius);border-bottom-right-radius:var(--borderRadius);overflow-y:scroll;padding-left:10%}.card-image{width:128px;height:128px;border-radius:var(--borderRadius);object-fit:contain}.image-wrapper{width:auto;display:flex;justify-content:center;align-items:center}.title{margin:0;font-size:1.3em;font-weight:600;text-overflow:ellipsis;color:var(--mainText);overflow:hidden;white-space:nowrap}.subtitle{margin:0;font-size:0.9em;color:var(--secondaryText);text-overflow:ellipsis;overflow:hidden;white-space:nowrap}.bodyText{display:flex;font-size:1em;overflow:hidden;text-overflow:ellipsis;color:var(--mainText);margin-bottom:0;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;line-clamp:3;-webkit-box-orient:vertical}.main-card-wrapper{flex:6;display:flex;flex-direction:column;gap:0.5em;overflow:hidden;}.wrapper-middle{flex:3;display:flex;flex-direction:column;justify-content:flex-start;min-width:0}.wrapper-right{flex:1;margin-left:2em;display:flex;flex-direction:column;justify-content:space-between;align-items:flex-end}.label-value-wrapper{display:flex;flex-direction:column;gap:5px}.label{font-size:12px;color:var(--secondaryText)}.value{font-size:16px;color:var(--mainText)}.alignRight{text-align:right}.children-text{color:var(--secondaryText);size:0.9em;text-decoration:underline}.tag-container{display:flex;gap:0.25em;flex-direction:row}.tag{border-radius:4px;padding:0.15em;padding-left:0.25em;padding-right:0.25em;gap:0.3em;flex-shrink:1;display:flex;justify-content:space-between;flex-direction:row;align-items:center}.tag-text{font-size:0.75em;font-weight:600;color:var(--tagText);text-wrap:nowrap}.detailed-card-container{width:100%;height:100%;padding:var(--padding);border-radius:var(--borderRadius);background-color:var(--mainBG);display:flex;overflow:hidden;gap:10px;}.detailed-metadata-container{background-color:var(--lighterBG);padding:var(--padding);flex:2;border-radius:var(--borderRadius);display:flex;flex-direction:column;justify-content:space-between}.detailed-metadata-content-container{flex:1}.detailed-metadata-content{display:flex;flex-direction:column;gap:0.75em;margin-top:0.75em}.detailed-main-card{padding:var(--padding)}.detailed-children-container{flex:1;width:-webkit-fill-available;height:-webkit-fill-available;margin-top:1em;padding-bottom:2em}.detailed-children-container>*{margin-top:0.25em;--lighterBG:var(--lighterBG)}.detailed-action-btns-container{display:flex;gap:1em;flex-direction:row-reverse;align-items:center}.detailed-main-wrapper{flex:7;display:flex;flex-direction:column}.minimal-card-container{position:relative;padding:0.1em;border-radius:var(--borderRadius);background-color:var(--lighterBG);display:flex;justify-content:space-between;align-items:center;max-height:3em;padding-left:0.5em;padding-right:0.5em;margin-bottom:0.5em}.minimal-child-wrapper{padding-left:2em}.minimal-title-container{display:flex;align-items:center}.minimal-title{font-size:0.9em;margin-left:0.5em}.minimal-children-btn{margin-left:0.5em}.tag-icon{color:var(--tagText);font-size:12px}.action-btn-icon{color:var(--mainText);height:1.5em;display:flex;align-items:center;gap:0.5em}`;
...
class DataCard {
    constructor(hostRef) {
        ...
        this.childrenVariant = 'minimal';
        this.nested = false;
        this.hasChildrenOpened = false;
        this.onActionPress = (identifier) => {
    ...
    render() {
        ...
        if (this.variant === 'minimal') {
            return (hAsync("div", null, hAsync("div", { class: "minimal-card-container", part: "minimal-card-container" }, hAsync("div", { class: "minimal-title-container" }, typeof parsedActionButtons !== 'string' &&
                (parsedActionButtons === null || parsedActionButtons === void 0 ? void 0 : parsedActionButtons.filter(action => action.position !== 'metadata-container').map(action => hAsync(ActionButton, { noLabel: true, action: action, onActionPress: this.onActionPress }))), hAsync("p", { class: "title minimal-title" }, typeof parsedTitle === 'string' ? parsedTitle : parsedTitle.value)), hAsync("div", { class: "minimal-title-container" }, hAsync("p", { class: "label" }, typeof parsedTextRight === 'string' ? parsedTextRight : parsedTextRight.value), typeof parsedChildren !== 'string' && parsedChildren && parsedChildren.length > 0 ? (hAsync("button", { onClick: this.onChildrenClick, class: "minimal-children-btn" }, hAsync("iconify-icon", { icon: `ci:chevron-${this.hasChildrenOpened ? 'up' : 'down'}`, height: "1.5em" }))) : null)), this.hasChildrenOpened ? (hAsync("div", { class: "minimal-children-container" }, typeof parsedChildren !== 'string' &&
                (parsedChildren === null || parsedChildren === void 0 ? void 0 : parsedChildren.map(child => (hAsync("div", { class: "minimal-child-wrapper" }, hAsync("data-card", Object.assign({ variant: "minimal", exportparts: "detailed-card-container, children-container, minimal-card-container, detailed-metadata-container, detailed-metadata-content-container, detailed-main-card, detailed-image-wrapper, image-wrapper, card-container, child-data-card, action-btn-icon, action-btn-iconify, subtitle, label-value-wrapper, tag, tag-icon, tag-text" }, child)))))))) : null));
        }
        if (this.variant === 'detailed') {
            return (hAsync("div", { class: "modal" }, hAsync("div", { class: "detailed-card-container", part: "detailed-card-container" }, parsedMetadata != undefined &&
                hAsync("div", { class: "detailed-metadata-container", part: "detailed-metadata-container" }, hAsync("div", { class: "detailed-metadata-content-container", part: "detailed-metadata-content-container" }, hAsync("p", { class: "title" }, "Metadata"), hAsync("div", { class: "detailed-metadata-content" }, typeof parsedMetadata !== 'string' &&
                    (parsedMetadata === null || parsedMetadata === void 0 ? void 0 : parsedMetadata.map(metadata => (hAsync(LabelValue, { label: metadata.label, value: metadata.value, valueTextClass: "bodyText", url: 'url' in metadata ? metadata.url : undefined, target: 'target' in metadata ? metadata.target : '_blank', detailed: true })))))), hAsync("div", { class: "detailed-action-btns-container" }, typeof parsedActionButtons !== 'string' &&
                    (parsedActionButtons === null || parsedActionButtons === void 0 ? void 0 : parsedActionButtons.filter(action => action.position === 'metadata-container').map(action => hAsync(ActionButton, { action: action, onActionPress: this.onActionPress }))))), hAsync("div", { class: "detailed-main-wrapper" }, hAsync("div", { class: "card-container detailed-main-card", part: "detailed-main-card" }, this.imageUrl && this.imageUrl !== '' ? (hAsync("div", { class: "image-wrapper", part: "detailed-image-wrapper" }, hAsync("img", { class: "card-image", src: this.imageUrl, alt: "card image" }))) : null, hAsync("div", { class: "main-card-wrapper" }, hAsync("div", { class: "tag-container" }, typeof parsedTags !== 'string' && (parsedTags === null || parsedTags === void 0 ? void 0 : parsedTags.map(tag => hAsync(TagComponent, { tag: tag, onActionPress: this.onActionPress })))), hAsync("div", { class: "main-card-body" }, hAsync("div", { class: "wrapper-middle" }, hAsync(TextProp, { prop: parsedTitle, textClass: "title" }), hAsync(TextProp, { prop: parsedSubtitle, textClass: "subtitle" }), hAsync(TextProp, { prop: parsedBodyText, textClass: "bodyText" })), hAsync("div", { class: "wrapper-right" }, hAsync(TextProp, { prop: parsedTextRight, alignRight: true, textClass: "bodyText" }))))), hAsync("div", { class: "detailed-children-container" }, typeof parsedChildren !== 'string' && (parsedChildren === null || parsedChildren === void 0 ? void 0 : parsedChildren.map(child => hAsync("data-card", Object.assign({ variant: "default" }, child, { nested: true, exportparts: "detailed-card-container, children-container, minimal-card-container, detailed-metadata-container, detailed-metadata-content-container, detailed-main-card, detailed-image-wrapper, image-wrapper, card-container, child-data-card, action-btn-icon, action-btn-iconify, subtitle, label-value-wrapper, tag, tag-icon, tag-text" }))))), hAsync("div", { class: "detailed-action-btns-container" }, typeof parsedActionButtons !== 'string' &&
                (parsedActionButtons === null || parsedActionButtons === void 0 ? void 0 : parsedActionButtons.filter(action => action.position !== 'metadata-container').map(action => hAsync(ActionButton, { action: action, onActionPress: this.onActionPress }))))))));
        }
        return (hAsync("div", null, hAsync("div", { part: "card-container", class: "card-container", style: {
                backgroundColor: this.nested ? 'var(--lighterBG)' : undefined,
            } }, this.imageUrl && this.imageUrl !== '' ? (hAsync("div", { class: "image-wrapper", part: "image-wrapper" }, hAsync("img", { class: "card-image", src: this.imageUrl, alt: "card image" }))) : null, hAsync("div", { class: "main-card-wrapper" }, typeof parsedTags !== 'string' && parsedTags && parsedTags.length > 0 ? (hAsync("div", { class: "tag-container" }, typeof parsedTags !== 'string' && (parsedTags === null || parsedTags === void 0 ? void 0 : parsedTags.map(tag => hAsync(TagComponent, { tag: tag, onActionPress: this.onActionPress }))))) : null, hAsync("div", { class: "main-card-body" }, hAsync("div", { class: "wrapper-middle" }, hAsync(TextProp, { prop: parsedTitle, textClass: "title" }), hAsync(TextProp, { prop: parsedSubtitle, textClass: "subtitle" }), hAsync(TextProp, { prop: parsedBodyText, textClass: "bodyText" })), hAsync("div", { class: "wrapper-right" }, hAsync(TextProp, { prop: parsedTextRight, alignRight: true, textClass: "bodyText" }))), hAsync("div", { class: "default-card-footer" }, parsedChildren ? (hAsync("button", { onClick: this.onChildrenClick, class: "default-children-button" }, hAsync("span", { class: "subtitle children-btn-label" }, parsedChildren.length, " ", (_a = this.childrenLabel) !== null && _a !== void 0 ? _a : 'Files / Children'))) : (hAsync("div", null)), hAsync("div", { class: "default-action-btns-container" }, typeof parsedActionButtons !== 'string' &&
            (parsedActionButtons === null || parsedActionButtons === void 0 ? void 0 : parsedActionButtons.filter(action => action.position !== 'metadata-container').map(action => hAsync(ActionButton, { action: action, onActionPress: this.onActionPress }))))))), this.hasChildrenOpened ? (hAsync("div", { class: "children-container", part: "children-container" }, typeof parsedChildren !== 'string' && (parsedChildren === null || parsedChildren === void 0 ? void 0 : parsedChildren.map(child => hAsync("data-card", Object.assign({}, child, { part: "child-data-card", exportparts: "detailed-card-container, children-container, minimal-card-container, detailed-metadata-container, detailed-metadata-content-container, detailed-main-card, detailed-image-wrapper, image-wrapper, card-container, child-data-card, action-btn-icon, action-btn-iconify, subtitle, label-value-wrapper, tag, tag-icon, tag-text", variant: this.childrenVariant })))))) : null));
    }
    static get style() { return dataCardCss(); }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "data-card",
        "$members$": {
            "imageUrl": [1, "image-url"],
            "dataTitle": [1, "data-title"],
            "subTitle": [1, "sub-title"],
            "bodyText": [1, "body-text"],
            "textRight": [1, "text-right"],
            "actionButtons": [1, "action-buttons"],
            "tags": [1],
            "childrenData": [1, "children-data"],
            "childrenLabel": [1, "children-label"],
            "metadata": [1],
            "variant": [1],
            "childrenVariant": [1, "children-variant"],
            "nested": [4],
            "hasChildrenOpened": [32]
        },
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
